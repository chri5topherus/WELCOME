...
public class MainController : MonoBehaviour {
	...
	void Update () {
		...
		if (pusherReceiver.newData) { 
			...
			pusherReceiver.firstname = "";
			pusherReceiver.lastname = "";
			pusherReceiver.gender = "";
			pusherReceiver.email = "";
		}
	...
	private void setFont() {
		...
		listWithMainTextFontElements[1].gameObject.transform.Find ("WhiteSmoke").SetParent (mainText.transform);
